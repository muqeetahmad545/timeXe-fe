...
export const AppHeader = () => {
  return (
    <div className="flex justify-between w-full items-center" style={{ backgroundColor: '#001529' }}>
      <Typography variant="h5" className="font-semibold" style={{color:"white"}}>X-Time</Typography>
      <div className="flex w-2/14 justify-around items-center">
        {userName && (
          <div className="flex items-center space-x-5 mr-5">
            <Avatar className="text-5xl">
