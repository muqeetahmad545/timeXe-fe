...
//   import { Avatar, Card, Col, Modal, Row, Spin, Table } from "antd";
...
export const RightSidebar = () => {
  ...
  return (
    <div className="px-2 py-4">
      ...
      {/* <Card loading={loading}>
        <Table  title={() => "Total Employees"} columns={columns} dataSource={users} rowKey="userId" />
      </Card> */}
      ...
      <div className="flex justify-around items-center mb-2 ml-10">
        {/* <Avatar><UserOutlined className="text-secondary-color"/></Avatar> */}
        {/* <div className="ml-12">
          <Typography>Present Employees List</Typography>
          <div className="text-secondary-color">
            {presentEmployees.map((employee, index) => (
              <div className="flex items-center" key={index}>
                <Typography>{index + 1}-{employee.userName}</Typography>
